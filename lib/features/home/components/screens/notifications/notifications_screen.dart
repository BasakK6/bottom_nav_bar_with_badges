...
class NotificationsScreen extends StatelessWidget {
  ...
  AppBar _buildAppBar() => AppBar(title: const Text(kNotificationsScreenTitle));
  ...
  Column _buildButtons() {
    return Column(
      ...
      children: const [
        CountChangeButton(
            isIncrease: true, screen: Screens.notificationsScreen),
        CountChangeButton(
            isIncrease: false, screen: Screens.notificationsScreen),
      ],
    );
  }
}
